...
def parse_valatree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .vala language file to load: ")

    try:
        tree = parse_valatree_tree(file_name)
        print("\nParsed vala language Tree:")
        print(tree)
